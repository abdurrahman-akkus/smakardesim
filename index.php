                ...
                <div class="u-custom-menu u-nav-container">
                    <ul class="u-nav u-spacing-2 u-unstyled u-nav-1">
                        <li class="u-nav-item"><a
                                    ...
                                    href="index.php" style="padding: 10px 20px;">Anasayfa</a></li>
                        <li class="u-nav-item"><a
                                    class="u-active-palette-1-base u-border-active-palette-1-base u-border-hover-palette-1-light-1 u-button-style u-hover-palette-1-light-1 u-nav-link u-text-active-white u-text-grey-90 u-text-hover-white"
                                    href="biz-kimiz.php" style="padding: 10px 20px;">BİZ KİMİZ</a></li>
                        <li class="u-nav-item"><a
                                    class="u-active-palette-1-base u-border-active-palette-1-base u-border-hover-palette-1-light-1 u-button-style u-hover-palette-1-light-1 u-nav-link u-text-active-white u-text-grey-90 u-text-hover-white"
                                    href="iletisim.php" style="padding: 10px 20px;">İLETİŞİM</a></li>
                        <li class="u-nav-item"><a
                                    class="u-active-palette-1-base u-border-active-palette-1-base u-border-hover-palette-1-light-1 u-button-style u-hover-palette-1-light-1 u-nav-link u-text-active-white u-text-grey-90 u-text-hover-white"
                                    href="yonetim/index.php" style="padding: 10px 20px;">GİRİŞ YAP</a></li>
                    </ul>
                </div>
                        ...
                        <div class="u-sidenav-overflow">
                            ...
                            <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="index.php"
                                                          style="padding: 10px 20px;">Anasayfa</a></li>
                                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="biz-kimiz.php"
                                                          style="padding: 10px 20px;">BİZ KİMİZ</a></li>
                                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="iletisim.php"
                                                          style="padding: 10px 20px;">İLETİŞİM</a></li>
                                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="yonetim/index.php"
                                                          style="padding: 10px 20px;">GİRİŞ YAP</a></li>
                            </ul>
                        </div>
                    </div>
    ...
    <section class="u-clearfix u-section-1" id="carousel_4587">
        <div class="u-clearfix u-sheet u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-valign-top-lg u-valign-top-xl u-sheet-1">
            <div id="carousel-8d1d" data-interval="5000" data-u-ride="carousel"
                ...
                <ol class="u-absolute-hcenter u-carousel-indicators u-carousel-indicators-1">
                    ...
                    for ($s = 1; $s <= sizeof($sliderCocuklar); $s++) {
                        ...
                        <li data-u-target="#carousel-8d1d"
                            class="<?php if ($s == 1) echo "u-active"; ?> u-active-palette-1-base u-hover-palette-1-base u-palette-1-light-2 u-shape-circle"
                            data-u-slide-to="<?= $s ?>" style="width: 10px; height: 10px;"></li>
                    <?php } ?>
                </ol>
                            ...
                            <div class="u-container-layout u-valign-top u-container-layout-1">
                                <div class="u-align-center-md u-align-center-sm u-align-center-xs u-align-left-lg u-align-left-xl u-container-style u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-group u-radius-20 u-shape-round u-white u-group-1">
                                    <div class="u-container-layout u-valign-middle u-container-layout-2">
                                        <h3 class="u-text u-text-palette-1-base u-text-1"><a
                                                    href="cocugumuz.php?id=<?= $sCocuk["id"] ?>"><?= $sCocuk["ad"] ?> <i
                                                        class="far fa-arrow-alt-circle-right"></i></a></h3>
                                        <p class="u-text u-text-palette-1-base u-text-2"><?= $sCocuk["kisa_aciklama"] ?>
                                            &nbsp;</p>
                                    </div>
                                </div>
                                <img src="<?= $sCocuk["resim_url"] ?>" alt="<?= $sCocuk["ad"] . "'e ait fotoğraf" ?>"
                                     class="u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-image u-image-round u-radius-20 u-image-1"
                ...
                <a class="u-absolute-vcenter u-carousel-control u-carousel-control-prev u-spacing-5 u-text-palette-1-base u-carousel-control-1"
                ...
                <a class="u-absolute-vcenter u-carousel-control u-carousel-control-next u-spacing-5 u-text-palette-1-base u-carousel-control-2"
            ...
            <a href="/tum-cocuklarimiz.php"
               class="u-align-center u-btn u-button-style u-hover-white u-palette-1-base u-btn-1">Tüm çocuklarımız<br>
            </a>
        </div>
    </section>
    <section
            class="u-align-center u-clearfix u-color-scheme-custom-color-scheme-1 u-color-style-multicolor-1 u-section-2"
            id="sec-5772">
                    ...
                    <div class="u-align-center u-border-2 u-border-white u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-container-layout-1">
                            ...
                            <h1 class="u-text u-title u-text-1" data-animation-name="counter"
                                ...
                                data-animation-duration="3000"><?= sizeof($cocuklar) ?></h1>
                    ...
                    <div class="u-align-center u-border-2 u-border-white u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-container-layout-2">
                            ...
                            <h1 class="u-text u-title u-text-3" data-animation-name="counter"
                                data-animation-event="scroll" data-animation-duration="3000"><?= $gonulluler ?></h1>
                    ...
                    <div class="u-align-center u-border-2 u-border-white u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-container-layout-3">
                            ...
                            <h1 class="u-text u-title u-text-5" data-animation-name="counter"
                                data-animation-event="scroll" data-animation-duration="3000"><?= $tamamlananlar ?></h1>
                ...
                <div class="u-repeater u-repeater-1">
                    ...
                    foreach ($hedefeYaklasanlar as $hCocuk) {
                        ...
                        <div class="cocuk">
                            ...
                            <div class="u-container-style back-img-container u-list-item u-repeater-item u-shading"
                                 data-image-width="2000" data-image-height="1333">
                                <img src="<?= $hCocuk["resim_url"] ?>" class="back-img">
                                <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1">
                                    <h3 class="u-text u-text-1"><a
                                                href="cocugumuz.php?id=<?= $hCocuk["id"] ?>"><?= $hCocuk["ad"] ?> <i
                                                    class="far fa-arrow-alt-circle-right"></i></a></h3>
                            ...
                            <div style="margin-top: -5px">
                                <div class="a-progress orange">
                                    <div class="a-progress-bar" val="<?= $hCocuk["yuzde"] ?>"
                                         style="width: <?= $hCocuk["yuzde"] ?>%; background:#f7810e;">
                    ...
                    foreach ($yeniBaslayanlar as $yCocuk) {
                        ...
                        <div class="cocuk">
                            ...
                            <div class="u-container-style back-img-container u-list-item u-repeater-item u-shading"
                                ...
                                <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1">
                                    <h3 class="u-text u-text-1"><a
                                                href="cocugumuz.php?id=<?= $yCocuk["id"] ?>"><?= $yCocuk["ad"] ?> <i
                                                    class="far fa-arrow-alt-circle-right"></i></a></h3>
                            ...
                            <div style="margin-top: -5px">
                                <div class="a-progress orange">
                                    <div class="a-progress-bar" val="<?= $yCocuk["yuzde"] ?>"
                                         style="width: <?= $yCocuk["yuzde"] ?>%; background:#f7810e;">
