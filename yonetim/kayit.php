                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="valilik_izin_baslangic"
                                               id="valilik_izin_baslangic" placeholder="01.01.2021">
                                    </div>
                                    <div class="form-group">
                                        <label>Valilik İzin Başlangıcı</label>
                                        <input type="date" class="form-control" name="valilik_izin_bitis"
                                               id="valilik_izin_bitis" placeholder="01.06.2021">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="button" name="submit" value="Kaydet" class="btn btn-default"
                                           onclick="kaydet()">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" id="hastalik_raporu">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" id="valilik_izni" name="valilik_izni">
                                </div>
                            </div>
                            <button id="yukle-buton" class="btn btn-default">Yükle</button>
                        </div>
                        <!-- /.row (nested) -->
                    </div>
                    <!-- /.panel-body -->
...
<script>
    // file upload kısmı
    let valilik_izni_path = "";
    $("#yukle-buton").click(function () { //dosya seçildiğinde
                ...
                $.ajax({ //dosya data sını ajax.php ye postala
                    ...
                    success: function (data) {
                        ...
                        if (data.message == "success") {
                            alert("Dosya başarıyla yüklendi", data.message);
                            valilik_izni_path = data.path
            ...
            reader.onload = function () { //veriyi yükle
                ...
                $.ajax({ //dosya data sını ajax.php ye postala
                    ...
                    success: function (data) {
                        ...
                        if (data.message == "success") {
                            alert("Dosya başarıyla yüklendi", data.message);
                            hastalik_raporu_path = data.path
                            file_button.after('<br><br><hr><br><img src="' + file_data + '" width="350px">'); //file input elemanının sonrasına ekle
                        } else {
                            alert(data); //hata mesajini goster
                        }
    ...
    function kaydet() {
        ...
        fetch('cocuk-api.php', {
            ...
            body: JSON.stringify({
                ...
                valilik_izni_url: valilik_izni_path,
                hastalik_raporu_url: hastalik_raporu_path,
                resim_url: resim_path,
