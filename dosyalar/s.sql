...
INSERT INTO `cocuk` VALUES (1,'Abdurrahman AKKUŞ(Örnek)','Ahmet AKKUŞ','+90 123 123 45 78','SMA-1','2021-01-01','2021-06-01',1000000,500000,50,'USD','2021-06-27 14:05:00','Bu parçada kısaca hastanın özet bilgisi paylaşılacaktır.','Bu kısımda hasta ile ilgili detaylı açıklama yapılacaktır. \nAçıklama içerisinde hikayesinden bahsedilmesi uygun olacaktır. \nOnun dışında bahsedilmek istenen bir şey varsa da eklenebilir.\nAyrıca <code>html</code> kodları da eklenebilir.\nBu kısımda hasta ile ilgili detaylı açıklama yapılacaktır. \nAçıklama içerisinde hikayesinden bahsedilmesi uygun olacaktır. \nOnun dışında bahsedilmek istenen bir şey varsa da eklenebilir.\nAyrıca <code>html</code> kodları da eklenebilir.\nBu kısımda hasta ile ilgili detaylı açıklama yapılacaktır. \nAçıklama içerisinde hikayesinden bahsedilmesi uygun olacaktır. \nOnun dışında bahsedilmek istenen bir şey varsa da eklenebilir.\nAyrıca <code>html</code> kodları da eklenebilir.\nBu kısımda hasta ile ilgili detaylı açıklama yapılacaktır. \nAçıklama içerisinde hikayesinden bahsedilmesi uygun olacaktır. \nOnun dışında bahsedilmek istenen bir şey varsa da eklenebilir.\nAyrıca <code>html</code> kodları da eklenebilir.\nBu kısımda hasta ile ilgili detaylı açıklama yapılacaktır. \nAçıklama içerisinde hikayesinden bahsedilmesi uygun olacaktır. \nOnun dışında bahsedilmek istenen bir şey varsa da eklenebilir.\nAyrıca <code>html</code> kodları da eklenebilir.\nBu kısımda hasta ile ilgili detaylı açıklama yapılacaktır. \nAçıklama içerisinde hikayesinden bahsedilmesi uygun olacaktır. \nOnun dışında bahsedilmek istenen bir şey varsa da eklenebilir.\nAyrıca <code>html</code> kodları da eklenebilir.\nBu kısımda hasta ile ilgili detaylı açıklama yapılacaktır. \nAçıklama içerisinde hikayesinden bahsedilmesi uygun olacaktır. \nOnun dışında bahsedilmek istenen bir şey varsa da eklenebilir.\nAyrıca <code>html</code> kodları da eklenebilir.\nBu kısımda hasta ile ilgili detaylı açıklama yapılacaktır. \nAçıklama içerisinde hikayesinden bahsedilmesi uygun olacaktır. \nOnun dışında bahsedilmek istenen bir şey varsa da eklenebilir.\nAyrıca <code>html</code> kodları da eklenebilir.\nBu kısımda hasta ile ilgili detaylı açıklama yapılacaktır. \nAçıklama içerisinde hikayesinden bahsedilmesi uygun olacaktır. \nOnun dışında bahsedilmek istenen bir şey varsa da eklenebilir.\nAyrıca <code>html</code> kodları da eklenebilir.','dosyalar/valilik_izni_ornek.pdf','dosyalar/hastalik_raporu_ornek.pdf',153,'dosyalar/baby1.jpg');
...
-- Dump completed on 2021-06-30  0:14:42
